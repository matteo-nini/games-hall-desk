...
<title><?= $h($cfg['nome_sala']) ?></title><link rel="stylesheet" href="styles.css"></head><body>
...
<div class="dash-hero">
  ...
  <a class="btnlink" href="giornaliero.php?data=<?= $oggi ?>">Cassa di oggi &rarr;</a>
</div>
...
<div class="dash-section">
  ...
  <div class="recent-list">
    ...
    <a class="recent-row" href="giornaliero.php?data=<?= $h($g['data']) ?>">
